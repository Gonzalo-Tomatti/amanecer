...
Se usa un array de arrays con datos para mostrar un dato curioso sobre el número del edificio más alto que va cambiando a medida que cambian las alturas. Se encuentra comentado el uso de la API "numbersapi" que realizaba esta tarea pero tuve que cambiarlo por problemas de compatibilidad entre los protocolos http y https. De probarse la página en una dirección http como localhost, se puede descomentar el fetch para usar la API.
